...
About this project - Basically it is a chat messaging app, It uses express and nodejs as the server. We make connections to the server using socket.io library. This also supports scrolling over the messages because of reac-scroll-to-bottom library. This project allows different users to connect to the same chat room and chat with each other.
